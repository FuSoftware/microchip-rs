        ...
        match opcode {
            ...
            0x50 => {
                ...
                return MCS51_Decompiler_Instruction {
                    ...
                    code: format!("JNC {:02x}", code_addr), //TODO Store as negative number
